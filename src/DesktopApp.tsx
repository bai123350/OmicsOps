...
import type { AgentEvent, KernelEvent, KernelLanguage, KernelSession, ModelProfile, PlanProposal, RemoteFileEntry, SkillPackage, WorkspaceConversation, WorkspaceMessage, WorkspaceProject, WorkspaceTemplate } from "./types";
...
export default function DesktopApp() {
  ...
  useEffect(() => {
    Promise.all([api.listProjects(), api.listModelProfiles(), api.listSkillPackages()]).then(([items, profiles, skills]) => {
