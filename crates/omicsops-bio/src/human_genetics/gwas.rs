use super::{
    GWAS, GWAS_API, GWAS_SITE, MAX_GWAS, bound_records, default_page, gwas_base, join_url,
    json_count, null_if_blank, optional_text, path_segment, require_efo_id, require_gcst,
    require_gene_symbol, require_pubmed_id, require_rs_id, require_text, send_json,
    send_json_not_found, string_list,
};
use crate::NativeBio;
