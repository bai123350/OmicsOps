use super::{
    Fetch, INTERPRO, INTERPRO_SITE, MAX_PAGES, MAX_PROTEINS, bound_page, default_architecture_max,
    default_clan_max, default_max, default_true, display_name, get_json, interpro_base, json_u64,
    metadata, page_size_for, path_segment, require_ids, require_text, resolve_next, taxon_id,
    text_field,
};
use crate::NativeBio;
