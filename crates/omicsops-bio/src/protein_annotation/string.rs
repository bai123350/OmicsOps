use super::{
    Fetch, MAX_IDS, STRING, STRING_SITE, bound_page, default_max, default_network_max,
    default_network_type, default_score, default_species, json_f64, post_json, require_ids,
    string_base, taxon_id, text_field,
};
use crate::NativeBio;
