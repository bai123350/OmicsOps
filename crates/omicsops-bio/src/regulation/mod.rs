        ...
        (
            ...
            ToolSchema::new(
                ...
                json_object(&[
                    (
                        "assay_title",
                        json_string("ENCODE assay_title, e.g. TF ChIP-seq or ATAC-seq."),
                    ),
                    ("target", json_string("Target protein label, e.g. CTCF.")),
                    (
                        "organism",
                        json_string("Scientific name, e.g. Homo sapiens."),
                    ),
                    (
                        "status",
                        json!({
                    ...
                    (
                        ...
                        json_string("ISO date YYYY-MM-DD sent as date_released=lte:DATE."),
                    ),
        ...
        (
            ...
            ToolSchema::new(
                ...
                json_object(&[
                    (
                        "term_name",
                        json_string("Biosample ontology term, e.g. K562 or liver."),
                    ),
                    (
                        "classification",
                        json_string("Biosample classification, e.g. cell line or tissue."),
                    ),
                    (
                        "organism",
                        json_string("Scientific name, e.g. Homo sapiens."),
                    ...
                    (
                        "date_created_before",
                        json_string("ISO date YYYY-MM-DD sent as date_created=lte:DATE."),
                    ),
                    ("extra_filters", extra_filters_schema()),
                    ("max_rows", json_max_rows(ENCODE_MAX_ROWS)),
                ]),
        ...
        (
            ...
            ToolSchema::new(
                ...
                json_object(&[
                    (
                        "file_format",
                        json_string("File format, e.g. fastq, bam, bigWig, bed."),
                    ),
                    (
                        "assay_term_name",
                        json_string("Assay ontology term, e.g. ChIP-seq. Not assay_title."),
                    ),
                    (
                        "biosample_term_name",
                        json_string("Biosample ontology term, e.g. K562."),
                    ),
                    (
                        "status",
                        json!({
        ...
        (
            ...
            ToolSchema::new(
                ...
                json_object(&[
                    ...
                    (
                        "tax_group",
                        json_string("Taxonomic group, e.g. vertebrates or plants."),
                    ),
                    (
                        "tax_id",
                        json!({
        ...
        (
            ...
            ToolSchema::new(
                ...
                json_object(&[
                    (
                        "tf_name",
                        json_string("TF gene symbol as used by UniBind, e.g. CTCF."),
                    ),
                    ...
                    (
                        "jaspar_id",
                        json_string("Versioned JASPAR matrix id, e.g. MA0139.1."),
                    ),
                    (
                        "search",
                        json_string("Free-text search across dataset fields."),
                    ),
                    ("page", json_page()),
                    ("max_rows", json_max_rows(LIST_MAX_ROWS)),
                ]),
